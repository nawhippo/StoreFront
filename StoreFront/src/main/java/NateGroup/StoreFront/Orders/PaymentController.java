...
public class PaymentController {
    ...
    private final PaymentTokenAuthService tokenService;
    private final OrderService orderService;

    @Autowired
    public PaymentController(PaymentTokenAuthService tokenService, OrderService orderService) {
        this.tokenService = tokenService;
        this.orderService = orderService;
    }
    //what's a model, is this thymeleaf, how to integrate w/ react frontend?
    //why do i need a seperate base url for sdk as opposed to the 3rd party app url to make requests to
    //what are base prereq scripts?
    ...
    //request bodies are formatted as json objects
    public ResponseEntity<?> createOrder(@RequestBody Request body) {
        try {
            //is this making a request to 3rd party url?
            String accessToken = tokenService.getAccessToken();

            //is this some kind of faux object?
            ...
            //this is essentially a complex series of strings all jammed into a custom order object.
